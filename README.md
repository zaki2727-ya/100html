...
<body>
    ...
    <label style="color: darkolivegreen;">Tag 9: Label</label>
    ...
    <ins style="text-decoration: underline; color: green;">Tag 49: Inserted Text</ins>
 

    <sup style="font-size: 0.7em; vertical-align: super;">Tag 50: Superscript Text</sup>
 


 

    <sub style="font-size: 0.7em; vertical-align: sub;">Tag 51: Subscript Text</sub>
 


 

    <br> <!-- Tag 52: Line Break -->
 

    <hr style="border: 2px dashed #ccc;"> <!-- Tag 53: Horizontal Rule -->
 


 

    <input type="checkbox" id="check" style="width: 20px; height: 20px;"> Tag 54: Checkbox<br>
 

    <input type="radio" name="option" style="width: 20px; height: 20px;"> Tag 55: Radio Button<br>
 


 

    <input type="password" placeholder="Tag 56: Password" style="width: 200px; padding: 5px;">
    ...
    <map name="image-map">
        ...
        <area shape="rect" coords="34,44,270,350" href="#" style="border: 1px solid red;">Tag 57: Image Map</area>
    ...
    <output style="background-color: lightyellow; padding: 5px;">Tag 58: Output Element</output>
 


 

    <input type="file" style="width: 200px;"> Tag 59: File Input<br>
 

    <input type="text" placeholder="Tag 60: Textbox" style="padding: 5px; width: 200px;">
    ...
    <figure style="margin: 20px;">
        ...
        <img src="https://via.placeholder.com/150" alt="Placeholder Image" style="width: 100%; border-radius: 10px;">
